 ...
 * @author quang
 */
public class people_window extends javax.swing.JFrame {

    /**
     * Creates new form people_window
     */
    public people_window() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(people_window.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new people_window().setVisible(true);
            }
        });
    }
